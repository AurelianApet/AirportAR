...
public class CameraPlaneController : MonoBehaviour {
	...
	public void init(bool bface)
	{
		...
		height = Screenheight ;
		width = Screenwidth;
        //this.transform.localPosition = new Vector3(0,0,8.6f);
        this.transform.localPosition = new Vector3(0, 0, 5.6f);
		...
		if (Screen.orientation == ScreenOrientation.Portrait||
			...
			transform.localScale = new Vector3(isFace?-height/10:height/10, 1.0f, width/10);
			#elif UNITY_IOS
			...
			transform.localScale = new Vector3(-1*height/10, 1.0f, isFace?-width/10:width/10);
			#endif
			...
			#elif UNITY_ANDROID
			transform.localEulerAngles = new Vector3(90,180,0);
			transform.localScale = new Vector3(isFace?-width/10:width/10, 1.0f, height/10);
			#elif UNITY_IOS
			transform.localEulerAngles = new Vector3(-90,0,0);
			transform.localScale = new Vector3(-1*width/10, 1.0f, isFace?-height/10:height/10);
			#endif
		}
	}
	...
	public void correctPlaneScale(float size)
	{
        ...
        if (screenRatio > 1f)
        {
            transform.localScale = new Vector3(1 , 1.0f, 1 / screenRatio);
        }
        else if (screenRatio < 1 && screenRatio > 0)
        {
            transform.localScale = new Vector3(1, 1.0f, screenRatio);
